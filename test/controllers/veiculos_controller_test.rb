...
class VeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post veiculos_url, params: { veiculo: { cor: @veiculo.cor, marca_id: @veiculo.marca_id, nome: @veiculo.nome, placa: @veiculo.placa, qnt_lugares: @veiculo.qnt_lugares, valor: @veiculo.valor } }
    end
  ...
  test "should update veiculo" do
    patch veiculo_url(@veiculo), params: { veiculo: { cor: @veiculo.cor, marca_id: @veiculo.marca_id, nome: @veiculo.nome, placa: @veiculo.placa, qnt_lugares: @veiculo.qnt_lugares, valor: @veiculo.valor } }
